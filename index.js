...
const SNS = require('./build/contracts/SNS')
const SNSRegistry = require('./build/contracts/SNSRegistry')
const SNSRegistryWithFallback = require('./build/contracts/SNSRegistryWithFallback')

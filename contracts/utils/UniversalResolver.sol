 ...
 * making it possible to make a single smart contract call to resolve an SNS name.
 */
contract UniversalResolver is IExtendedResolver, ERC165 {
    ...
    SNS public immutable registry;

    constructor(address _registry) {
        registry = SNS(_registry);
    }

    /**
     * @dev Performs SNS name resolution for the supplied name and resolution data.
     * @param name The name to resolve, in normalised and SNS-encoded form.
     * @param data The resolution data, as specified in SNSIP-10.
    ...
    /**
     * @dev Performs SNS name reverse resolution for the supplied reverse name.
     * @param reverseName The reverse name to resolve, in normalised and SNS-encoded form. e.g. b6E040C9ECAaE172a89bD561c5F73e1C48d28cd9.addr.reverse
     ...
     * @param name The name to resolve, in SNS-encoded and normalised form.
